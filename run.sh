...
#poetry run ecofuture_preproc denan_chiplets -source_name tmax -roi_name savanna -pad_size_pix 32
...
#poetry run ecofuture_preproc denan_chiplets -source_name rain -roi_name savanna -pad_size_pix 32
...
#poetry run ecofuture_preproc chiplets_to_geotiff -source_name land_use -roi_name savanna
#poetry run ecofuture_preproc plot_maps -source_name land_use -roi_name savanna
...
#poetry run ecofuture_preproc chiplets_to_geotiff -source_name fire_scar_early -roi_name savanna
#poetry run ecofuture_preproc plot_maps -source_name fire_scar_early -roi_name savanna
...
#poetry run ecofuture_preproc chiplets_to_geotiff -source_name fire_scar_late -roi_name savanna
#poetry run ecofuture_preproc plot_maps -source_name fire_scar_late -roi_name savanna
...
#poetry run ecofuture_preproc to_chiplets -source_name soil_depth -roi_name savanna -pad_size_pix 32
#poetry run ecofuture_preproc to_chiplets -source_name soil_depth -roi_name savanna -pad_size_pix 0
#poetry run ecofuture_preproc denan_chiplets -source_name soil_depth -roi_name savanna -pad_size_pix 32
...
#poetry run ecofuture_preproc to_chiplets -source_name soil_clay -roi_name savanna -pad_size_pix 32
#poetry run ecofuture_preproc to_chiplets -source_name soil_clay -roi_name savanna -pad_size_pix 0
#poetry run ecofuture_preproc denan_chiplets -source_name soil_clay -roi_name savanna -pad_size_pix 32
...
#poetry run ecofuture_preproc to_chiplets -source_name soil_ece -roi_name savanna -pad_size_pix 32
#poetry run ecofuture_preproc to_chiplets -source_name soil_ece -roi_name savanna -pad_size_pix 0
#poetry run ecofuture_preproc denan_chiplets -source_name soil_ece -roi_name savanna -pad_size_pix 32
