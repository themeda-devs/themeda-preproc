...
poetry run themeda_preproc pad_chiplets -chiplets_path ~/preproc/data/chiplets/roi_savanna/pad_0/land_cover/chiplets_land_cover_2020_roi_savanna_pad_0.npy -output_path ~/preproc/mnt/analysis/pad_test_2.npy -dtype uint8 -roi_name savanna  
